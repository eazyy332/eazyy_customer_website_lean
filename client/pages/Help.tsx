    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="hidden">
        <nav className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-6">
            <Link to="/help" className="text-primary font-medium">Help</Link>
      ...
      <section className="px-4 lg:px-16 py-12 lg:py-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 leading-relaxed mb-8">
            Find answers to common questions and get the support you need to make the most of your
          </p>
          ...
          <div className="max-w-lg mx-auto">
            <div className="relative">
              <input 
                ...
                className="w-full px-6 py-4 bg-gray-50 border border-gray-200 rounded-full text-lg focus:ring-2 focus:ring-primary focus:border-transparent outline-none transition-colors"
              />
              <button className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-primary text-white p-3 rounded-full hover:bg-blue-700 transition-colors">
      ...
      <section className="px-4 lg:px-16 py-12">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-medium text-black mb-8 text-center">Popular Topics</h2>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition-shadow cursor-pointer">
              ...
              <h3 className="text-xl font-medium text-black mb-2">Scheduling & Pickup</h3>
              <p className="text-gray-600 mb-4">Learn how to schedule pickups, change appointments, and manage your orders.</p>
              <div className="text-primary font-medium hover:underline">View Articles →</div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition-shadow cursor-pointer">
              ...
              <h3 className="text-xl font-medium text-black mb-2">Pricing & Billing</h3>
              <p className="text-gray-600 mb-4">Understand our pricing structure, payment methods, and billing questions.</p>
              <div className="text-primary font-medium hover:underline">View Articles →</div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition-shadow cursor-pointer">
              ...
              <h3 className="text-xl font-medium text-black mb-2">Service Quality</h3>
              <p className="text-gray-600 mb-4">Get answers about our cleaning process, care instructions, and quality guarantee.</p>
              <div className="text-primary font-medium hover:underline">View Articles →</div>
            </div>
          </div>
        </div>
      ...
      <section className="px-4 lg:px-16 py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">Get instant answers to the most common questions</p>
          </div>

          <div className="space-y-6">
            <details className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
              <summary className="text-lg font-medium text-black cursor-pointer">How do I schedule my first pickup?</summary>
              <div className="mt-4 text-gray-600">
                <p>Getting started is easy! Simply visit our website or download our app, create an account, enter your address, and select your preferred pickup time. We offer flexible scheduling with same-day and next-day options available in most areas.</p>
              </div>
            </details>

            <details className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
              <summary className="text-lg font-medium text-black cursor-pointer">What areas do you serve?</summary>
              <div className="mt-4 text-gray-600">
                <p>We currently serve over 50 major metropolitan areas across the United States. To check if we serve your area, simply enter your zip code on our homepage or in the app. We're constantly expanding to new cities!</p>
              </div>
            </details>

            <details className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
              <summary className="text-lg font-medium text-black cursor-pointer">How much does the service cost?</summary>
              <div className="mt-4 text-gray-600">
                <p>Our wash & fold service starts at $24.99 for up to 15 lbs of laundry. Dry cleaning prices vary by item type, starting at $12.99 per piece. We offer transparent pricing with no hidden fees, and you can see the exact cost before confirming your order.</p>
              </div>
            </details>

            <details className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
              <summary className="text-lg font-medium text-black cursor-pointer">How long does it take to get my clothes back?</summary>
              <div className="mt-4 text-gray-600">
                <p>Our standard turnaround time is 24-48 hours for wash & fold service and 2-3 business days for dry cleaning. We also offer express service for urgent items, which can be completed within 24 hours for an additional fee.</p>
              </div>
            </details>

            <details className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
              <summary className="text-lg font-medium text-black cursor-pointer">What if something goes wrong with my order?</summary>
              <div className="mt-4 text-gray-600">
                <p>We stand behind our work with a 100% satisfaction guarantee. If you're not completely happy with any item, we'll re-clean it for free or provide a full refund. Simply contact our customer service team within 7 days of delivery to resolve any issues.</p>
              </div>
            </details>

            <details className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
              <summary className="text-lg font-medium text-black cursor-pointer">Do you offer contactless service?</summary>
              <div className="mt-4 text-gray-600">
                <p>Yes! We offer completely contactless pickup and delivery. Simply leave your laundry in a designated safe location (like your doorstep or building lobby), and we'll collect and return it without any face-to-face interaction. You'll receive notifications when we arrive and depart.</p>
              </div>
            </details>

            <details className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
              <summary className="text-lg font-medium text-black cursor-pointer">What products do you use for cleaning?</summary>
              <div className="mt-4 text-gray-600">
                <p>We use only premium, eco-friendly detergents and cleaning products that are gentle on fabrics and safe for your family. All our products are hypoallergenic and biodegradable. If you have specific allergies or preferences, please let us know in your order notes.</p>
              </div>
            </details>

            <details className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
              <summary className="text-lg font-medium text-black cursor-pointer">Can I track my order?</summary>
              <div className="mt-4 text-gray-600">
                <p>Absolutely! You can track your order in real-time through our app or website. You'll receive notifications when we pick up your items, when cleaning begins, and when your order is out for delivery. We believe in complete transparency throughout the process.</p>
              </div>
            </details>

            <details className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
              <summary className="text-lg font-medium text-black cursor-pointer">Do you clean specialty items like wedding dresses or leather?</summary>
              <div className="mt-4 text-gray-600">
                <p>Yes, we specialize in cleaning delicate and specialty items including wedding dresses, leather goods, designer clothing, and vintage pieces. These items require special care and may have different pricing and turnaround times. Please contact us for a custom quote.</p>
              </div>
            </details>

            <details className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
              <summary className="text-lg font-medium text-black cursor-pointer">How do I cancel or modify my order?</summary>
              <div className="mt-4 text-gray-600">
                <p>You can cancel or modify your order through the app or website up to 2 hours before your scheduled pickup time. After pickup, modifications aren't possible, but you can always contact our customer service team if you have special requests or concerns.</p>
              </div>
            </details>
          </div>
        </div>
      ...
      <section className="px-4 lg:px-16 py-20">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl lg:text-5xl font-medium text-black mb-6">Still Need Help?</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-medium text-black mb-2">Contact Form</h3>
              <p className="text-gray-600 mb-4">Fill out our detailed form</p>
      ...
      {/* Footer */}
      <footer className="mx-4 lg:mx-16 mb-8">
...
// Add EazyyIcon component at the end of the file
